...
rawdata <- readMat("/home/uczlhpe/Scratch/corn.mat")
...
system.time({
  ...
  #corn_PLS(n)
  n <- as.matrix(rep(60,300))                            #the number of calibration, rep(a:b,c): from a to b and repeat c. 
  ...
  #cat(signif(PlotDataMean[2],3),"(",signif(PlotDataSd[2],3),")","\n")
  cat(signif(PlotDataMean[3],3),"(",signif(PlotDataSd[3],3),")","\n")
})
stopCluster(cl)
```
...
system.time({
  ...
  #corn_PLS(n)
  n <- as.matrix(rep(40,300))                         #the number of calibration, rep(a:b,c): from a to b and repeat c. 
  #PlsResult <- apply(n,1,corn_PLS)                     #loop
  PlsResult <- parSapply(cl,n,corn_PLS)                #optimizated loop
  PlotData <- as.data.frame(cbind(n,t(PlsResult)))     #combind the results
  par(mfrow=c(1,2))
...
system.time({
  ...
  #corn_PLS(n)
  n <- as.matrix(rep(64,300))                            #the number of calibration, rep(a:b,c): from a to b and repeat c. 
  #PlsResult <- apply(n,1,corn_PLS)                     #loop
  PlsResult <- parSapply(cl,n,corn_PLS)               #optimizated loop
  PlotData <- as.data.frame(cbind(n,t(PlsResult)))     #combind the results
  par(mfrow=c(1,2))
...
system.time({
  ...
  #corn_PLS(n)
  n <- as.matrix(rep(52,300))                            #the number of calibration, rep(a:b,c): from a to b and repeat c. 
  #PlsResult <- apply(n,1,corn_PLS)                     #loop
  PlsResult <- parSapply(cl,n,corn_PLS)                #optimizated loop
  PlotData <- as.data.frame(cbind(n,t(PlsResult)))     #combind the results
  par(mfrow=c(1,2))
