...
system.time({
  ...
  PlotData <- as.data.frame(cbind(n,t(PlsResult)))     #combind the results
  #par(mfrow=c(1,2))
  #boxplot(V2~V1,data=PlotData,xlab="Number of calibration set", ylab="RMSECV",main="PLS of moisture on mp5")
  #boxplot(V3~V1,data=PlotData,xlab="Number of calibration set", ylab="RMSEP",main="PLS of moisture on mp5")
  #PlotDataMean <- apply(PlotData,2,mean)
  #PlotDataSd <- apply(PlotData,2,sd)
  #cat(PlotDataMean[2]-PlotDataSd[2],PlotDataMean[2],PlotDataMean[2]+PlotDataSd[2],"\n")
  #cat(PlotDataMean[3]-PlotDataSd[3],PlotDataMean[3],PlotDataMean[3]+PlotDataSd[3],"\n")
...
PlotData <- rbind(a,b,c)
par(mfrow=c(1,2))
boxplot(V2~V1,data=PlotData,xlab="Pre-treatment type", ylab="RMSECV",main="PLS of moisture on mp5")
boxplot(V3~V1,data=PlotData,xlab="Pre-treatment type", ylab="RMSEP",main="PLS of moisture on mp5")
...
PlotData <- rbind(a,b,c)
par(mfrow=c(1,2))
boxplot(V2~V1,data=PlotData,xlab="Pre-treatment type", ylab="RMSECV",main="PLS of oil on mp5")
boxplot(V3~V1,data=PlotData,xlab="Pre-treatment type", ylab="RMSEP",main="PLS of oil on mp5")
...
PlotData <- rbind(a,b,c)
par(mfrow=c(1,2))
boxplot(V2~V1,data=PlotData,xlab="Pre-treatment type", ylab="RMSECV",main="PLS of protein on mp5")
boxplot(V3~V1,data=PlotData,xlab="Pre-treatment type", ylab="RMSEP",main="PLS of protein on mp5")
...
PlotData <- rbind(a,b,c)
par(mfrow=c(1,2))
boxplot(V2~V1,data=PlotData,xlab="Pre-treatment type", ylab="RMSECV",main="PLS of starch on mp5")
boxplot(V3~V1,data=PlotData,xlab="Pre-treatment type", ylab="RMSEP",main="PLS of starch on mp5")
...
system.time({
  ...
  PlotData <- as.data.frame(cbind(n,t(PlsResult)))     #combind the results
  #par(mfrow=c(1,2))
  #boxplot(V2~V1,data=PlotData,xlab="Number of calibration set", ylab="RMSECV",main="PLS of moisture on mp6")
  #boxplot(V3~V1,data=PlotData,xlab="Number of calibration set", ylab="RMSEP",main="PLS of moisture on mp6")
  #PlotDataMean <- apply(PlotData,2,mean)
  #PlotDataSd <- apply(PlotData,2,sd)
  #cat(PlotDataMean[2]-PlotDataSd[2],PlotDataMean[2],PlotDataMean[2]+PlotDataSd[2],"\n")
  #cat(PlotDataMean[3]-PlotDataSd[3],PlotDataMean[3],PlotDataMean[3]+PlotDataSd[3],"\n")
...
PlotData <- rbind(a,b,c)
par(mfrow=c(1,2))
boxplot(V2~V1,data=PlotData,xlab="Pre-treatment type", ylab="RMSECV",main="PLS of moisture on mp6")
boxplot(V3~V1,data=PlotData,xlab="Pre-treatment type", ylab="RMSEP",main="PLS of moisture on mp6")
...
PlotData <- rbind(a,b,c)
par(mfrow=c(1,2))
boxplot(V2~V1,data=PlotData,xlab="Pre-treatment type", ylab="RMSECV",main="PLS of oil on mp6")
boxplot(V3~V1,data=PlotData,xlab="Pre-treatment type", ylab="RMSEP",main="PLS of oil on mp6")
...
PlotData <- rbind(a,b,c)
par(mfrow=c(1,2))
boxplot(V2~V1,data=PlotData,xlab="Pre-treatment type", ylab="RMSECV",main="PLS of protein on mp6")
boxplot(V3~V1,data=PlotData,xlab="Pre-treatment type", ylab="RMSEP",main="PLS of protein on mp6")
...
PlotData <- rbind(a,b,c)
par(mfrow=c(1,2))
boxplot(V2~V1,data=PlotData,xlab="Pre-treatment type", ylab="RMSECV",main="PLS of starch on mp6")
boxplot(V3~V1,data=PlotData,xlab="Pre-treatment type", ylab="RMSEP",main="PLS of starch on mp6")
